    ...
    (U.fn.expander = function (e) {
          ...
          init: function () {
            this.each(function () {
              ...
              if (((v.moreSelector = "span." + E.split(" ").join(".")), (v.lessSelector = "span." + T.split(" ").join(".")), !U.data(this, "expanderInit"))) {
                for (
                  U.data(this, "expanderInit", !0),
                    U.data(this, "expander", v),
                    U.each(["onSlice", "beforeExpand", "afterExpand", "onCollapse", "afterCollapse"], function (e, a) {
                      m[a] = U.isFunction(v[a]);
                    }),
                    n = (k = F(k)).replace(L, "").length;
                  n < v.slicePoint;
                    ...
                    (k = F(
                      (k = v.sliceOn
                        ? (function (e) {
                            ...
                            return e;
                          })({ sliceOn: v.sliceOn, slicePoint: v.slicePoint, allHtml: b, summaryText: k }).summaryText
                        : k),
                      v.preserveWords && b.slice(k.length).length
                    )).match($) || [],
                    t = k.match(D) || [],
                    l = [],
                    U.each(T, function (e, a) {
                      j.test(a) || l.push(a);
                    }),
                    T = l,
                    a = t.length,
                ...
                (v.moreLabel = h.find(v.moreSelector).length
                  ...
                  y ? (i = b) : "&" === k.charAt(k.length - 1) && (c = /^[#\w\d\\]+;/.exec(i)) && ((i = i.slice(c[0].length)), (k += c[0])),
                  (v.summary = k += r),
                  (v.details = i),
                  (v.lastCloseTag = r),
                  (y = (function (e, a) {
                    ...
                    a
                      ? ((l = "div"),
                        n && "a" !== t && !e.expandAfterSummary ? (s = s.replace(I, e.moreLabel + "$1")) : (s += e.moreLabel),
                        (s = '<div class="' + e.summaryClass + '">' + s + "</div>"))
                      : (s += e.moreLabel);
                    return [s, e.detailPrefix || "", "<", l + ' class="' + e.detailClass + '"', ">", e.details, "</" + l + ">"].join("");
                  })((v = m.onSlice ? ((l = v.onSlice.call(x, v)) && l.details ? l : v) : v), y)),
                  h.empty().append(y),
                  (o = h.find(w)),
                  (d = h.find(v.moreSelector)),
                  ("slideUp" === v.collapseEffect && "slideDown" !== v.expandEffect) || h.is(":hidden") ? o.css({ display: "none" }) : o[v.collapseEffect](0),
                  (C = h.find("div." + v.summaryClass)),
                  (y = function (e) {
                    e.preventDefault();
                    e = e.startExpanded ? 0 : S;
                    d.hide(),
                      C.hide(),
                      m.beforeExpand && v.beforeExpand.call(x),
                      o.stop(!1, !0)[v.expandEffect](e, function () {
                        var e, a, l;
                        o.css({ zoom: "" }),
                          m.afterExpand && v.afterExpand.call(x),
                          (a = o),
                          (l = x),
                          (e = v).collapseTimer &&
                  ...
                  d.find("a").off("click.expander").on("click.expander", y),
                  v.userCollapse &&
                    !h.find(v.lessSelector).length &&
                    h
                      .find(w)
                      .append(
                        '<span class="' +
                  ...
                  v.startExpanded && y({ preventDefault: function () {}, startExpanded: !0 });
              }
            });
          },
          destroy: function () {
            this.each(function () {
              var e,
                ...
                l = U(this);
              l.data("expanderInit") &&
                ((e = U.extend({}, l.data("expander") || {}, O)),
                (a = l.find("." + e.detailClass).contents()),
                l.removeData("expanderInit"),
                l.removeData("expander"),
                l.find(e.moreSelector).remove(),
                l.find("." + e.summaryClass).remove(),
                l
                  .find("." + e.detailClass)
                  .after(a)
                  .remove(),
                l.find(e.lessSelector).remove());
            });
          },
        };
      function F(e, a) {
      ...
      function H(e, a) {
        a.stop(!0, !0)[e.collapseEffect](e.collapseSpeed, function () {
          a.prev("span." + e.moreClass).show().length ||
            a
              .parent()
